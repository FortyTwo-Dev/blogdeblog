...
<body>
    <form class="flex flex-col gap-4 items-center justify-center" method="POST" action="{{ route('register.store') }}">
        @csrf
        @method('post')
        ...
        <input class="border" type="password" name="password_confirmation" id="password_confirmation">
